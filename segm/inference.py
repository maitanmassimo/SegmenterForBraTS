...
from segm.data.brats_slice import brats_slice_CATS_PATH
...
def main(model_path, input_dir, output_dir, gpu):
    ...
    cat_names, cat_colors = dataset_cat_description(brats_slice_CATS_PATH)
    ...
    for filename in tqdm(list_dir, ncols=80):
        ...
        pil_blend.save(output_dir / "blend_"+ filename.name)

...
data_root = "data/brats_slice_wt_test"
img_norm_cfg = dict(
...
data = dict(
    ...
    trainval=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir=["images/training", "images/testing"],
        ann_dir=["annotations_WT/training", "annotations_WT/testing"],
        pipeline=train_pipeline,
    ),
    val=dict(
        type=dataset_type,
        ...
        ann_dir="annotations_WT/testing",
